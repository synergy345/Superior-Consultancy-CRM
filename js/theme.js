...
$(document).ready(function () {
  ...
  // currency and language select start
...
function screenToggle() {
  const fullIcon = $(".expand_icon");
  // Check if the current page is not in fullscreen mode using the Fullscreen API
  if (
    !document.fullscreenElement &&
    !document.webkitFullscreenElement &&
    !document.mozFullScreenElement
  ) {
    // Enter fullscreen mode using one of three different methods, depending on the browser
    ...
    fullIcon.toggleClass("la-expand la-compress");
  } else {
    // Exit fullscreen mode using one of three different methods, depending on the browser
    if (document.exitFullscreen) document.exitFullscreen();
    else if (document.webkitExitFullscreen) document.webkitExitFullscreen();
    else if (document.mozCancelFullScreen) document.mozCancelFullScreen();
    fullIcon.toggleClass("la-compress la-expand ");
  }
}

document.addEventListener("keydown", function (event) {
  if (event.key === "Escape") {
    let fullIcon = $(".expand_icon");
    if (fullIcon.hasClass("la-compress")) {
      fullIcon.toggleClass("la-expand la-compress");
    }
  }
});
